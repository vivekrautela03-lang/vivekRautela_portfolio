...
export default function Projects() {
  const [projectList, setProjectList] = React.useState(STATIC_PROJECTS);
      ...
      try {
        ...
        if (!error && data && data.length > 0) {
          const formatted = data.map((p) => ({
            ...
            image: p.image || "/images/tov_studio.png",
        ...
        console.warn("Could not fetch projects from Supabase. Falling back to static data.");
      }
    };
    loadProjects();
  }, []);
