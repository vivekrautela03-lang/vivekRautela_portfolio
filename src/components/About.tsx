...
export default function About() {
  return (
    <section id="about" className="relative py-24 md:py-32 bg-[#ffffff] z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 flex justify-center">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-tr from-[#0070f3]/10 to-[#7928ca]/10 rounded-[32px] filter blur-xl opacity-40 group-hover:opacity-75 transition-opacity duration-500" />
              
              {/* Glass Frame Borders */}
              <div className="absolute -inset-2 border border-black/[0.04] rounded-[36px] pointer-events-none group-hover:scale-[1.03] group-hover:-rotate-2 transition-all duration-500" />
              <div className="absolute -inset-4 border border-black/[0.01] rounded-[40px] pointer-events-none group-hover:scale-[1.05] group-hover:rotate-1 transition-all duration-500" />

              {/* Core Image Container */}
              <div className="relative w-full h-full rounded-[32px] overflow-hidden border border-black/[0.08] bg-white/45 p-2 shadow-2xl backdrop-blur-md">
          ...
          <div className="lg:col-span-7 text-center md:text-left">
            <motion.h3
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="text-xl md:text-2xl font-heading font-semibold text-[#050505] mb-6 leading-relaxed"
            >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.1, duration: 0.6 }}
              className="text-slate-600 space-y-5 text-sm md:text-base leading-relaxed font-normal"
            >
              <p>
